...
using NxRasterSource = FindAndExplore.Mapping.Sources.RasterSource;
using NxRasterDemSource = FindAndExplore.Mapping.Sources.RasterDemSource;
using NxGeojsonSource = FindAndExplore.Mapping.Sources.GeoJsonSource;
using NxVectorSource = FindAndExplore.Mapping.Sources.VectorSource;
//using NxImageSource = FindAndExplore.Mapping.Sources.MapboxImageSource;
using NxGeoJsonOptions = FindAndExplore.Mapping.Sources.GeoJsonOptions;
using NxTileSet = FindAndExplore.Mapping.Sources.TileSet;

...
using NxLayer = FindAndExplore.Mapping.Layers.Layer;
using NxCircleLayer = FindAndExplore.Mapping.Layers.CircleLayer;
using NxFillExtrusionLayer = FindAndExplore.Mapping.Layers.FillExtrusionLayer;
using NxFillLayer = FindAndExplore.Mapping.Layers.FillLayer;
using NxForegroundLayer = FindAndExplore.Mapping.Layers.ForegroundLayer;
using NxHeatmapLayer = FindAndExplore.Mapping.Layers.HeatmapLayer;
using NxHillshadeLayer = FindAndExplore.Mapping.Layers.HillshadeLayer;
using NxSymbolLayer = FindAndExplore.Mapping.Layers.SymbolLayer;
using NxStyleLayer = FindAndExplore.Mapping.Layers.StyleLayer;
using NxLineLayer = FindAndExplore.Mapping.Layers.LineLayer;
using NxBackgroundLayer = FindAndExplore.Mapping.Layers.BackgroundLayer;
using NxRasterLayer = FindAndExplore.Mapping.Layers.RasterLayer;
...
namespace FindAndExplore.Droid.Mapping
{
    ...
    public static partial class LayerExtensions
    {
        ...
        public static TransitionOptions ToNative(this FindAndExplore.Mapping.TransitionOptions options)
        {

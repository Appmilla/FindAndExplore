...
namespace FindAndExplore.Mapping.Expressions
{
    public partial class Expression
    {
        ...
        {
            return Match(Join(Join(new Expression[] { input }, Expressions.Stop.ToExpressionArray(stops)), new Expression[] { defaultOutput }));
        }
        ...
        {
            return Step(Literal(input), defaultOutput, Expressions.Stop.ToExpressionArray(stops));
        }
        ...
        {
            return Step(input, defaultOutput, Expressions.Stop.ToExpressionArray(stops));
        }
